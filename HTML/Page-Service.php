...
<div class="wrapper">
    <section class="Service">
        ...
        <ul>
            <li>
                <img src="../images/Service__img/Service__webdesign.png" alt="デザインと制作、画像">
            ...
            <li>
                <img src="../images/Service__img/Service__coding.png" alt="コーディング画像">
                <div class="Service__text">
                    <h3>コーディング</h3>
            ...
            <li>
                <img src="../images/Service__img/Service__wordpress.png" alt="WordPress">
                <div class="Service__text">
                    <h3>WordPress</h3>
    ...
    <section class="Flow">
        ...
        <ul>
            <li>
                    ...
                    <div class="Flow__img">
                        <img src="../images/Service__img/Flow__contact.png" alt="お問い合わせ、画像">
                    </div>
            ...
            <li>
                    ...
                    <div class="Flow__img">
                        <img src="../images/Service__img/Flow__hearing.png" alt="ヒアリング、画像">
                    </div>
                <div class="Flow__text">
                    <h3>ヒアリング</h3>
            ...
            <li>
                    ...
                    <div class="Flow__img">
                        <img src="../images/Service__img/Flow__estimation.png" alt="お見積もり、画像">
                    </div>
                <div class="Flow__text">
                    <h3>お見積もり</h3>
            ...
            <li>
                    ...
                    <div class="Flow__img">
                        <img src="../images/Service__img/Flow__making.png" alt="制作制作、画像">
                    </div>
                <div class="Flow__text">
                    <h3>制作</h3>
            ...
            <li>
                    ...
                    <div class="Flow__img">
                        <img src="../images/Service__img/Flow__delively.png" alt="納品、画像">
                    </div>
                <div class="Flow__text">
                    <h3>納品</h3>
